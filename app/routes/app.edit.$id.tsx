      ...
      <Form method="post">
        ...
        <BlockStack gap="400">
          <TextField
            ...
            name="title"
            value={editvalue}
            onChange={(editvalue) => seteditvalue(editvalue)}
            autoComplete="off"
          />
          <FormLayout.Group>
            <TextField
          ...
          <TextField
            ...
            value={minorder}
            onChange={(minorder) => setminorder(Number(minorder))}
            autoComplete="off"
          />
          <TextField
            label="Minimun Order Quantity"
            name="minimumOrderQuantity"
            value={minorderquantity}
            onChange={(minorderquantity) =>
              setminorderquantity(Number(minorderquantity))
            }
            autoComplete="off"
          />
